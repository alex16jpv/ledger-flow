...
export const CATEGORY_COLOR_STYLES: Record<CategoryColor, CategoryColorStyle> = {
  RED:    { bg: "bg-red-50",     border: "border-red-400",    ring: "ring-red-400/30",    dot: "bg-red-400" },
  ORANGE: { bg: "bg-orange-50",  border: "border-orange-400", ring: "ring-orange-400/30", dot: "bg-orange-400" },
  AMBER:  { bg: "bg-amber-50",   border: "border-amber-400",  ring: "ring-amber-400/30",  dot: "bg-amber-400" },
  YELLOW: { bg: "bg-yellow-50",  border: "border-yellow-400", ring: "ring-yellow-400/30", dot: "bg-yellow-400" },
  LIME:   { bg: "bg-lime-50",    border: "border-lime-500",   ring: "ring-lime-500/30",   dot: "bg-lime-500" },
  GREEN:  { bg: "bg-green-50",   border: "border-green-500",  ring: "ring-green-500/30",  dot: "bg-green-500" },
  TEAL:   { bg: "bg-teal-50",    border: "border-teal-400",   ring: "ring-teal-400/30",   dot: "bg-teal-400" },
  CYAN:   { bg: "bg-cyan-50",    border: "border-cyan-500",   ring: "ring-cyan-500/30",   dot: "bg-cyan-500" },
  BLUE:   { bg: "bg-blue-50",    border: "border-blue-400",   ring: "ring-blue-400/30",   dot: "bg-blue-400" },
  INDIGO: { bg: "bg-indigo-50",  border: "border-indigo-400", ring: "ring-indigo-400/30", dot: "bg-indigo-400" },
  PURPLE: { bg: "bg-purple-50",  border: "border-purple-400", ring: "ring-purple-400/30", dot: "bg-purple-400" },
  PINK:   { bg: "bg-pink-50",    border: "border-pink-400",   ring: "ring-pink-400/30",   dot: "bg-pink-400" },
  ROSE:   { bg: "bg-rose-50",    border: "border-rose-400",   ring: "ring-rose-400/30",   dot: "bg-rose-400" },
  GRAY:   { bg: "bg-stone-50",   border: "border-stone-400",  ring: "ring-stone-400/30",  dot: "bg-stone-400" },
  BROWN:  { bg: "bg-amber-50",   border: "border-amber-600",  ring: "ring-amber-600/30",  dot: "bg-amber-600" },
  BLACK:  { bg: "bg-stone-100",  border: "border-stone-800",  ring: "ring-stone-800/30",  dot: "bg-stone-800" },
};

...
| `--heat-1` … `--heat-4`                                                                  | the four steps of the calendar heatmap, derived from the brand seed. Steps 1–3 carry `--text`, step 4 `--on-brand`; `npm run contrast-check` verifies the four pairs in both modes and both palettes |
